...
def visualize_data(fp_1 : __file__, fp_2 : __file__, fp_3 : __file__, fp_4 : __file__, matrix : str, machine_name : str):
  ...
  make_time_plot(average_keys_rma_dynamic, average_data_rma_dynamic, f"{matrix} average run time on {machine_name} (RMA_DYNAMIC)", f"./{matrix}/{matrix}_{machine_name}_RMA_DYNAMIC_average_plot.png")
  make_time_plot(max_keys_rma_dynamic, max_data_rma_dynamic, f"{matrix} max run time on {machine_name} (RMA_DYNAMIC)", f"./{matrix}/{matrix}_{machine_name}_RMA_DYNAMIC_max_plot.png")
  make_time_plot(min_keys_rma_dynamic, min_data_rma_dynamic, f"{matrix} min run time on {machine_name} (RMA_DYNAMIC)", f"./{matrix}/{matrix}_{machine_name}_RMA_DYNAMIC_min_plot.png")
...
for matrix in matrix_directories:
  ...
  fp_4 = open(f"./{matrix}/{matrix}_{machine_name}_RMA_DYNAMIC_data.txt","w")
