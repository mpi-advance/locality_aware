        ...
        MPI_Comm comm, int ppg, int socket_rank)
{
    ...
    { 
        ...
        gpuMemcpy(recvbuf_std, recvbuf_d_local, s*sizeof(float), gpuMemcpyDeviceToHost);
...
int main(int argc, char* argv[])
{
    ...
    cudaCheck(cudaMemcpy(sendbuf_d_local, sendbuf, max_s_proc*sizeof(float), cudaMemcpyHostToDevice));
