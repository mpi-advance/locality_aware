...
NeighborAlltoallvInitMethod mpix_neighbor_alltoallv_init_implementation =
        NEIGHBOR_ALLTOALLV_INIT_STANDARD;

int init_communication(const void* sendbuffer, int n_sends, const int* send_procs,
        const int* send_ptr, MPI_Datatype sendtype, void* recvbuffer, int n_recvs,
        const int* recv_procs, const int* recv_ptr, MPI_Datatype recvtype, int tag,
        MPI_Comm comm, int* n_request_ptr, MPI_Request** request_ptr);
        ...
        MPIX_Request** request_ptr)
{
    ...
    return method(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts,
            rdispls, recvtype, topo, comm, info, request_ptr);
}
        ...
        MPIX_Request** request_ptr)
{
    ...
    MPIX_Neighbor_alltoallv_init_topo(sendbuf, sendcounts, sdispls, sendtype,
...
{    
    ...
    {
        case NEIGHBOR_ALLTOALLV_INIT_STANDARD:
            return neighbor_alltoallv_init_standard(sendbuf, sendcounts,
                    sdispls, sendtype, recvbuf, recvcounts, rdispls,
                    recvtype, topo, comm, info, request_ptr);
        case NEIGHBOR_ALLTOALLV_INIT_LOCALITY:
            return neighbor_alltoallv_init_locality_ext(sendbuf, sendcounts,
                    sdispls, global_sindices, sendtype, recvbuf, 
                    recvcounts, rdispls, global_rindices, recvtype, 
                    topo, comm, info, request_ptr);
        default:
            return neighbor_alltoallv_init_standard(sendbuf, sendcounts,
                    sdispls, sendtype, recvbuf, recvcounts, rdispls,
                    recvtype, topo, comm, info, request_ptr);
        ...
        MPIX_Request** request_ptr)
{
    ...
    MPIX_Neighbor_alltoallv_init_ext_topo(sendbuf, sendcounts, sdispls, global_sindices, sendtype,
            recvbuf, recvcounts, rdispls, global_rindices, recvtype, topo, comm, info, request_ptr);
        ...
        MPIX_Request** request_ptr)
{
    ...
    MPIX_Neighbor_alltoallv_topo(global_send_indices, sendcounts, global_sdispls, MPI_LONG, 
            global_recv_indices, recvcounts, global_rdispls, MPI_LONG, topo, comm);

    int err = neighbor_alltoallv_init_locality_ext(sendbuffer, sendcounts, sdispls, 
