 ...
 * @details
 * Rotates such that new_start_byte is first in array. Divides recvbuf into two parts
 * [first, middle] and (middle, last) then swaps their positioning. Example: A = 0, 1, 2,
 * 3, 4, 5 std::rotate(A*, 2, A*+6) would split into (0, 1) and (2, 3, 4, 5) and after
 * running A = 2, 3, 4, 5, 0, 1
 *
 * @param [in, out] recvbuf buffer of elements to rotate
 * @param [in] new_start_byte index immediately after the split point.
 ...
 * @details Divides recvbuf into two parts [first, middle] and (middle, last) then swaps
 * their positioning. Example: A = 0, 1, 2, 3, 4, 5 std::rotate(A*, 2, A*+6) would split
 * into (0, 1) and (2, 3, 4, 5) and after running A = 2, 3, 4, 5, 0, 1
 *
 * @param [in, out] recvbuf buffer of elements to rotate
