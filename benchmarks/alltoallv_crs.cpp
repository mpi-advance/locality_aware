...
n_iter=1;
    ...
    compare(n_recvs, s_recvs, src.data(), recvcounts.data(), rdispls.data(), recvvals.data(), A.send_comm.n_msgs, A.send_comm.size_msgs, proc_count.data(), proc_displs.data(),orig_indices.data());
